  ...
  return (
    '<a href="listing.html?id=' + listing.id + '" class="listing">' +
      ...
      '<div class="listing-body">' +
        ...
        '<div class="listing-detail-line">' + listing.beds + " bd · " + listing.baths + " ba · " + listing.maxTenants + " tenants · " + listing.r.campusDriveMin + " min drive to campus · " + listing.r.seagrapeWalkMin + " min to The Seagrape</div>" +
